/* ==========================================================================
   COLLEGE EVENT ATTENDANCE TRACKER - FRONTEND JAVASCRIPT
   ========================================================================== */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let currentChartView = 'overall'; // 'overall' | 'year' | 'branch'
    ...
    // DOM Elements - Gate Verification Search
    ...
    // DOM Elements - Directory Table & Filters
    ...
    // DOM Elements - Analytics Switcher
    ...
    // --- MODE SWITCHER (UNIFIED CONTAINER NAVIGATION) ---
        ...
        if (found) {
            ...
            verifyResultContainer.innerHTML = `
                <div class="student-card not-found">
                    <div>
                        <i class="fa-solid fa-triangle-exclamation" style="font-size:2rem; color:#e11d48; margin-bottom:0.5rem;"></i>
                ...
                <div style="flex:1;">
                    <div style="display:flex; align-items:center; gap:0.75rem;">
                        ...
                        <span class="badge ${isPresent ? 'badge-success' : 'badge-warning'}">
                            <i class="fa-solid ${isPresent ? 'fa-circle-check' : 'fa-clock'}"></i>
                ...
                <div>
                    ...
                    ` : `
                        <button class="btn btn-outline" disabled style="opacity:0.75; cursor:default;">
                            <i class="fa-solid fa-check-double"></i> Verified Entry
                        </button>
                    `}
                </div>
            </div>
            ...
            <tr>
                ...
                <td>
                    <span class="badge ${p.isPresent ? 'badge-success' : 'badge-warning'}">
                        <i class="fa-solid ${p.isPresent ? 'fa-circle-check' : 'fa-clock'}"></i>
                ...
                <td style="text-align: right;">
                    ...
                    ` : `<span style="color:#059669; font-size:0.85rem; font-weight:600;"><i class="fa-solid fa-check"></i> Verified</span>`}
                </td>
            </tr>
        `).join('');
